...
public class MySession  implements Serializable {
    ...
    public MySession(Channel session) {
    ...
    public boolean equals(Object o) {
        if (o instanceof MySession) {
            MySession target = (MySession) o;
    ...
    public static MySession decode(byte[] protobufBody) throws InvalidProtocolBufferException {
